...
const AcidDashboard: React.FC<AcidDashboardProps> = ({ stats, startNewInspection, fetchHistory, isLoadingHistory, historyList, onViewReport, onPrint, userRole }) => {
    ...
    return (
      <div className="max-w-6xl mx-auto space-y-6 animate-fadeIn">
          {/* Header Card - Compact */}
          <div className="bg-gradient-to-r from-purple-800 to-indigo-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
               <div className="absolute top-0 right-0 p-4 opacity-10">
                   <svg className="w-64 h-64 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l-5.5 9h11z"/><path d="M10 13v6h4v-6z"/></svg>
               </div>
               <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                   <div>
                       <h2 className="text-2xl font-bold mb-4">Acid Tanker Inspection</h2>
                       <div className="flex flex-wrap gap-4">
                           {canCreate && (
                               <button 
                                 onClick={startNewInspection}
                                 className="px-6 py-2.5 bg-white text-purple-900 hover:bg-gray-100 font-bold rounded-xl shadow-lg transition transform hover:scale-105 flex items-center gap-2"
                               >
                   ...
                   <div className="flex gap-4">
                       <div className="bg-black/20 backdrop-blur-md rounded-xl p-3 text-center min-w-[90px]">
                           ...
                           <div className="text-[10px] text-purple-200 uppercase tracking-wide">Total</div>
                       </div>
                       <div className="bg-black/20 backdrop-blur-md rounded-xl p-3 text-center min-w-[90px]">
                           <div className="text-2xl font-bold">{stats.passRate}%</div>
                           <div className="text-[10px] text-purple-200 uppercase tracking-wide">Compliance</div>
                       </div>
                   </div>
               </div>
          </div>
           ...
           <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 flex items-center gap-2">
                   ...
                   <div className="relative w-full md:w-72">
                      ...
                      <input 
                          ...
                          className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all"
                      />
                  </div>
              </div>
              ...
              {isLoadingHistory ? (
                  ...
                  <div className="py-12 text-center">
                      <div className="text-gray-400 mb-2">No acid tanker inspections found.</div>
