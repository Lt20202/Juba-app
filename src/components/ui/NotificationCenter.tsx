...
interface NotificationCenterProps {
    ...
    onClearAll: () => void;
    onAcknowledge?: (id: string) => void; // New prop for permanent resolution
...
const NotificationCenter: React.FC<NotificationCenterProps> = ({ 
    ...
    const handleAcknowledgeClick = (e: React.MouseEvent, id: string) => {
        ...
        if (onAcknowledge) {
            ...
            onAcknowledge(id);
            // Spinner will be shown via local state, parent will remove item from list on success
        }
    };
                                    ...
                                    >
                                        <div className="flex gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                {(n.type === 'critical' || n.type === 'warning') && canAcknowledge && onAcknowledge && (
