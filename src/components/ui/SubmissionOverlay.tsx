                ...
                {status === 'offline_saved' && (
                    <div className="flex flex-col items-center gap-4 py-4">
                        <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center">
                            <svg className="w-10 h-10 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                        </div>
                        <div>
                            <h3 className="text-xl font-black text-gray-900">Saved Offline</h3>
                            <p className="text-sm text-gray-500 mt-1">Data saved to device. Will sync when online.</p>
                            <p className="text-xs text-amber-600 mt-4 font-medium uppercase tracking-wide">Redirecting to Dashboard...</p>
                        </div>
                    </div>
                )}
            </div>
